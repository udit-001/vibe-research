...
# -*- coding: utf-8 -*-
"""
Validate whether JSON research results cover all fields defined in fields.yaml.

Usage:
    python validate_json.py --fields fields.yaml --dir ./results
    python validate_json.py --fields fields.yaml --json item1.json item2.json
"""
...
# Category mapping for nested structures
CATEGORY_MAPPING = {
...
def extract_json_fields(data, category_mapping=None):
    """Extract all field names from JSON data, handling nested structures."""
...
def validate_json(json_path, all_fields, required_fields, field_categories):
    """Validate a single JSON file against field definitions."""
